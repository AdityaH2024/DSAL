...
table implementation to quickly look up clients telephone Number. Make Use of two 
Collision Techniques and Compare them using number of Comparisons required to find a set 
...
class doubleHashTable:
    ...
    def h2(self, element):
        M=int(input("\n Please enter prime number lesser than Table time"))
        collisionH2= (M-(element % M))
        print("\n H2 double hashing value",collisionH2)
        return collisionH2
   
    # method to resolve collision by double hashing method
    def doubleHashTable(self, record):
        posFound = False
