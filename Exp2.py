...
a) Add (new element) - place a value into a set, b) Remove (element) - remove the value 
c) Contains (element) - return true if element is in a collection, d) Size () - return number of 
values in collection iterator() return an iterator used to loop over collection, e) Intersection of 
two sets, f) Union of two set g) Difference between two sets, h) Subset 
"""
